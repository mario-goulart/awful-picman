...
;; Core units
(use irregex posix files srfi-1 srfi-13 extras data-structures setup-api ports srfi-4)

;; Eggs
(use awful-sql-de-lite imlib2 spiffy simple-sha1 sql-de-lite json free-gettext hostinfo)
